      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="Home page/index.html">Home <span class="sr-only"></span></a>
          </li>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-6 heading-spacing">
          ...
          <button type="button" class="btn btn-outline-light btn-lg download-button btn-success mx-2" data-toggle="modal" data-target="#loginModal"> Get Started</button>
          <!-- <a href="" data-toggle="modal" data-target="#loginModal" class="btn btn-outline-light btn-lg download-button"> Get Started </a> -->
           <!-- <button type="button" class="btn btn-success mx-2"  data-toggle="modal" data-target="#loginModal">Get Started</button> -->
        </div>
        <div class="col-lg-6">
