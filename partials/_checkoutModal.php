        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="address" name="address" placeholder="1234 Main St" type="text-area" required minlength="3" maxlength="500"></textarea> 
                </div>
               <!--  <div class="form-group">
...
<!--                     <a href="partials/razorpay/pay.php?amounta=<?php echo $totalPrice?>" name="checkout" class="btn btn-dark">Order</a> -->
                    <button type="submit" name="checkout" class="btn btn-dark">Order</button>
